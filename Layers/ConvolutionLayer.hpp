...
namespace RLDNN
{
    ...
    public:
        ...
        TensorType forwardImpl(TensorsWithNames<TensorType> argX){
            ...
            { 
                for_dot(conv.data(),patches.data(),{patches.dimension(0),patches.dimension(1),patches.dimension(2),patches.dimension(3),patches.dimension(4)},
                        m_filter.data(),{m_filter.dimension(0),m_filter.dimension(1),m_filter.dimension(2),m_filter.dimension(3)});
            }
        ...
        TensorsWithNames<TensorType> backwardImpl(Tensor4xf& dout){
            ...
            {
                db_dot(dB.data(),dout.data(),{dout.dimension(0),dout.dimension(1),dout.dimension(2),dout.dimension(3)});
            }
            ...
            {
                dw_dot(dW.data(),{dW.dimension(0),dW.dimension(1),dW.dimension(2),dW.dimension(3)},
                        dout.data(),{dout.dimension(0),dout.dimension(1),dout.dimension(2),dout.dimension(3)},
                        x.data(),{x.dimension(0),x.dimension(1),x.dimension(2),x.dimension(3)});
            }
            ...
            {
                filter_dot(flip_filter.data(),{flip_filter.dimension(0),flip_filter.dimension(1),flip_filter.dimension(2),flip_filter.dimension(3)},
                        m_filter.data(),{m_filter.dimension(0),m_filter.dimension(1),m_filter.dimension(2),m_filter.dimension(3)});
            }
            ...
            {
                bac_dot(conv.data(),patches.data(),{patches.dimension(0),patches.dimension(1),patches.dimension(2),patches.dimension(3),patches.dimension(4)},
                        flip_filter.data(),{flip_filter.dimension(0),flip_filter.dimension(1),flip_filter.dimension(2),flip_filter.dimension(3)});
            }   
        ...
        Eigen::Tensor<float, 4,Eigen::RowMajor> convert_tensor_1 (Eigen::Tensor<float, 4,Eigen::RowMajor> x)
        {
            ...
            {
                convert(out.data(),{out.dimension(0),out.dimension(1),out.dimension(2),out.dimension(3)},
                        x.data(),{x.dimension(0),x.dimension(1),x.dimension(2),x.dimension(3)});
            }
            return out;
        }
    ...
    private:
        ...
        Tensor4xf x_padding(Tensor4xf &argX,int out_h,int out_w,std::vector<int> strides){
            ...
            {
                padding_dot(padding_x.data(),{padding_x.dimension(0),padding_x.dimension(1),padding_x.dimension(2),padding_x.dimension(3)},{padding[0],padding[1]},
                        argX.data(),{argX.dimension(0),argX.dimension(1),argX.dimension(2),argX.dimension(3)});
            }
            return padding_x;
        }  
    };
